...
class __TwigTemplate_87dc28ebca565c115ce862209b8848dd154b841485f9ad7b114a12d558b24ec8 extends Twig_Template
{
...
";
    ...
    <section class=\"hero-area\">
        ...
        // line 53
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("img/bg-img/1.jpg"), "html", null, true);
        echo ");\"></div>
                    ...
                    <div class=\"row h-1 align-items-center\">
                        <div class=\"col-12\">
                            ...
                            <div class=\"hero-slides-content text-center\">
                                <h2>Les plantes existent dans la météo et les rayons lumineux qui les entourent</h2>
                                <div class=\"welcome-btn-group\">
                                    <a href=\"#\" class=\"btn alazea-btn mr-30\">Debuter ici</a>
                                    <a href=\"#\" class=\"btn alazea-btn active\">contacter nous</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class=\"single-hero-post bg-overlay\">
                ...
                <div class=\"slide-img bg-img\" style=\"background-image: url(";
        // line 73
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("img/bg-img/2.jpg"), "html", null, true);
        echo ");\"></div>
                <div class=\"container h-1\">
                    <div class=\"row h-1 align-items-center\">
                        <div class=\"col-12\">
        ...
        echo "\" class=\"btn alazea-btn mr-30\">Debuter ici</a>
                                    <a href=\"#\" class=\"btn alazea-btn active\">contacter nous</a>
                                </div>
                            </div>
                        </div>
...
";
    ...
    {
        return array (  199 => 105,  190 => 104,  160 => 82,  148 => 73,  125 => 53,  105 => 36,  100 => 33,  91 => 32,  51 => 3,  42 => 2,  11 => 1,);
    }
                    ...
                    <div class=\"row h-1 align-items-center\">
                        <div class=\"col-12\">
                            ...
                            <div class=\"hero-slides-content text-center\">
                                ...
                                <div class=\"welcome-btn-group\">
                                    <a href=\"{{ path('homepage') }}\" class=\"btn alazea-btn mr-30\">Debuter ici</a>
                                    <a href=\"#\" class=\"btn alazea-btn active\">contacter nous</a>
                                </div>
                            </div>
                        </div>
...
{% endblock %}", "default/index.html.twig", "C:\\xampp\\htdocs\\pepiniere123\\app\\Resources\\views\\default\\index.html.twig");
    }
}
